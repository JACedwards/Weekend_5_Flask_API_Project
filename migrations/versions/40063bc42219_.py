...
Revision ID: 40063bc42219
Revises: 
Create Date: 2022-05-26 10:12:16.029328
...
def upgrade():
    ...
    op.add_column('animal', sa.Column('image', sa.String(length=255), nullable=True))
